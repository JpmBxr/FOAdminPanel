<template>
  <v-app>
    ...
    <idle-dialog-component :isIdleDialogProp="isIdle"></idle-dialog-component>
          ...
          <v-list-item link class="pl-0">
            <v-list-item-content>
              ...
              <v-list-item-subtitle>
                <v-icon small color="gray darken-2">mdi-phone</v-icon>
          ...
          <template>
            ...
            >
              ...
              <v-list-item
                ...
                ><v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title>Submitted Assignment</v-list-item-title>
                </v-list-item-content>
              </v-list-item>
              <v-list-item
              ...
              <v-list-item
                ...
                ><v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title v-text="labelStream"></v-list-item-title>
                </v-list-item-content>
              </v-list-item>
              <v-list-item
                v-permission="'Course'"
              ...
              <v-list-item
                ...
                ><v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title v-text="labelSubject"></v-list-item-title>
                </v-list-item-content>
              </v-list-item>
              ...
              <v-list-item
                ...
                ><v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title v-text="labelTopic"></v-list-item-title>
                </v-list-item-content>
              </v-list-item> </v-list-group
          ></template>
          <!-- Academics End -->
          ...
          <template>
            ...
            >
              ...
              <v-list-item
                ...
                ><v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title>Question Bank-Copy</v-list-item-title>
                </v-list-item-content>
              </v-list-item>
              ...
              <v-list-item
                ...
                ><v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title>Exam Schedule</v-list-item-title>
                </v-list-item-content>
              </v-list-item>
            </v-list-group></template
          >
          ...
          <template v-permission="'Reports'">
            ...
            >
              ...
              <v-list-item
                ...
                ><v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title>Exam Report</v-list-item-title>
                </v-list-item-content>
              </v-list-item>
              <v-list-item
              ...
              <v-list-item
                ...
                ><v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title>Book Issue Report</v-list-item-title>
                </v-list-item-content>
              </v-list-item>
            </v-list-group></template
          >
          ...
          <template>
            ...
            >
              ...
              <v-list-item
                ...
                ><v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title>Issue Book</v-list-item-title>
                </v-list-item-content>
              </v-list-item>
            </v-list-group></template
          >
          ...
          <template>
            ...
            >
              ...
              >
                <v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title v-text="labelPrefix"></v-list-item-title>
                </v-list-item-content>
              </v-list-item>
              ...
              >
                <v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title>Session Setting</v-list-item-title>
                </v-list-item-content>
              </v-list-item>
              ...
              >
                <v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title>SMS Setting</v-list-item-title>
                </v-list-item-content>
              </v-list-item>
              ...
              >
                <v-list-item-action> </v-list-item-action>
                <v-list-item-content>
                  <v-list-item-title>Email Setting</v-list-item-title>
                </v-list-item-content>
              </v-list-item>
    ...
    <v-row justify="center">
      <v-dialog v-model="changePasswordDialog" scrollable max-width="450px">
        <v-card>
          <v-card-title>{{ $t("label_change_password") }}</v-card-title>
          ...
          <v-card-actions>
            ...
            <v-btn
              ...
              text
              :disabled="
                !isholdingFormValid || isforgotPasswordFormDataProcessing
              "
...
export default {
  ...
  methods: {
    ...
    changePassword($event) {
      let userDecision = confirm(this.$t("label_are_you_sure_change_pasword"));
      if (userDecision) {
