            ...
            >
              ...
              <v-row dense class="mx-2">
                <v-col cols="12" xs="12" sm="12" md="12">
                  <v-textarea outlined dense v-model="courseDescription">
                    <template #label>
              ...
              <v-row dense class="mx-2">
                ...
                <v-col cols="12" xs="12" sm="12" md="6">
                  ...
                  >
                    ...
                    <template #label>{{ $t("label_course_image") }}</template>
                  </v-file-input>
                </v-col>
              </v-row>
              ...
              <div dense class="mx-2 text-center mb-2">
                <v-btn
                  ...
                  color="primary"
                  :disabled="
                    !isSaveCourseFormValid || isSaveCourseFormDataProcessing
                  "
                  @click="isAddCardVisible = !isAddCardVisible"
                >
...
export default {
  ...
  data() {
    return {
      ...
      excelData: [],
      excelFileName:
        "StreamListAsExcel" + "_" + moment().format("DD/MM/YYYY") + ".xls",
    };
  },
  watch: {
        ...
        this.$http
          .post(
            "web_enable_disable_course",
            {
              ...
              isCourseActive: item.lms_course_is_active == "Active" ? 0 : 1,
      ...
      if (this.$refs.saveCourseForm.validate()) {
        ...
        if (this.isSaveEditClicked == 1) {
          ...
          if (this.courseDescription != "") {
            postData.append("courseDescription", this.courseDescription);
          }
          ...
          if (this.selectedCourseImage != null) {
            postData.append("courseImage", this.selectedCourseImage);
          }
        ...
        this.$http
          .post("web_save_update_course", postData, this.authorizationConfig)
          .then(({ data }) => {
            ...
            if (
              ...
              // Course Saved
                ...
                this.selectedCourseImage = null;
                this.snackBarColor = "success";
                this.changeSnackBarMessage(this.$t("label_course_saved"));
                this.getAllCourse(event);
              ...
              // Course Updated
                ...
                this.snackBarColor = "success";
                this.changeSnackBarMessage(this.$t("label_course_updated"));
                this.getAllCourse(event);
                this.isSaveEditClicked = 1;
                this.courseCode = "";
                this.courseName = "";
