...
export default {
  ...
  data() {
    return {
      ...
      excelData: [],
      excelFileName:
        "CourseListAsExcel" + "_" + moment().format("DD/MM/YYYY") + ".xls",
    };
  },
  watch: {
        ...
        this.$http
          .post(
            "web_enable_disable_child_course",
            {
              ...
              isCourseActive:
                item.lms_child_course_is_active == "Active" ? 0 : 1,
    ...
    saveChildCourse($event) {
      if (this.$refs.saveChildCourseForm.validate()) {
        ...
        if (this.isSaveEditClicked == 1) {
          ...
          postData.append("childCourseDuration", this.childCourseDuration);
          if (this.selectedChildCourseImage != null) {
            postData.append("courseImage", this.selectedChildCourseImage);
          }
          ...
          .then(({ data }) => {
            ...
            if (
              ...
              // Course Code Exists
                ...
                this.changeSnackBarMessage(this.$t("label_course_exists"));
              }
              // Course Saved
              else if (data.responseData == 2) {
